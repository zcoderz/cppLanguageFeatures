...
#ifndef CPPLANGUAGEFEATURES_PREFER_MAKE_UNIQUE_AND_SHARED_H
#define CPPLANGUAGEFEATURES_PREFER_MAKE_UNIQUE_AND_SHARED_H

#include <iostream>
#include <memory>
#include <vector>

namespace MakeUniqueAndSharedExample {
...
#endif //CPPLANGUAGEFEATURES_PREFER_MAKE_UNIQUE_AND_SHARED_H
